...
Run id : `20260830_203744` — 2026-08-30T20:37:44.758890+00:00. as_of=2026-08-30T20:37:44.758895+00:00
...
evidence: `{'as_of': '2026-08-30T20:37:44.758895+00:00', 'checked_active_versions': [{'model_type': 'dixon_coles', 'version': 'xfoot-dixon-coles-v1', 'status': 'AVAILABLE'}, {'model_type': 'elo', 'version': 'xfoot-elo-v4', 'status': 'AVAILABLE'}, {'model_type': 'xgboost', 'version': 'xfoot-xgboost-v3', 'status`
...
- Monitoring opérationnel mais sans données réelles suffisantes à observer actuellement.
...
- Aucune décision Phase 8I n'a encore été exercée sur une donnée RÉELLE prospective (0 shadow decision REAL capturée) — mécanisme testé, jamais éprouvé en conditions réelles.
...
- [ ] decision_layer_validated — gate DECISION status=CONDITIONAL
- [x] shadow_healthy — gate SHADOW status=PASS
- [ ] monitoring_healthy — gate MONITORING status=CONDITIONAL
