...
def test_health(client):
    ...
    body = r.json()
    assert set(body["leagues_loaded"]) == {
        "Ligue1", "PremierLeague", "LaLiga", "Bundesliga", "SerieA", "PrimeiraLiga",
        "MLS", "SaudiProLeague", "ChampionsLeague", "EuropaLeague", "ConferenceLeague",
    }
